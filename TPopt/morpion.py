...
def recupere_chaine_a_afficher(symbole):
    ...
    # TODO
    ...
    if symbole=='x':return CRED + "\u2715" + CEND
    elif symbole=='o':return CBLUE + "\u25cb" + CEND
    return symbole
...
def affiche_plateau(cases):
    ...
    ...
    print("+---+---+---+")
    print("| ",recupere_chaine_a_afficher(cases[0])," | ",recupere_chaine_a_afficher(cases[1])," | ",recupere_chaine_a_afficher(cases[2])," |")
    print("+---+---+---+")
    print("| ",recupere_chaine_a_afficher(cases[3])," | ",recupere_chaine_a_afficher(cases[4])," | ",recupere_chaine_a_afficher(cases[5])," |")
    print("+---+---+---+")
    print("| ",recupere_chaine_a_afficher(cases[6])," | ",recupere_chaine_a_afficher(cases[7])," | ",recupere_chaine_a_afficher(cases[8])," |")
    print("+---+---+---+")
...
def joue_coup(joueur, joueur_num, cases, symbole):
    ...
    # TODO
    ...
    affiche_plateau(tuple(cases))
    cases[joueur.joueur_num(cases,symbole)]=symbole
    affiche_plateau(tuple(cases))
    if cases[0]==cases[1]==cases[2] or cases[3]==cases[4]==cases[5] or cases[6]==cases[7]==cases[8] or cases[0]==cases[3]==cases[6] or cases[1]==cases[4]==cases[7] or cases[2]==cases[5]==cases[8] or cases[0]==cases[4]==cases[8] or cases[2]==cases[4]==cases[6]:
        print('Le joueur ',joueur_num,' gagne.')
    else:
        return cases             
